 ...
 * @author raulalvarado
 */
public class FlooringMasteryOrdersProdFileImpl implements FlooringMasteryOrdersDao {
    ...
    public FlooringMasteryOrdersProdFileImpl() {
        
    }
    public FlooringMasteryOrdersProdFileImpl(String orderFolder) {
    ...
    private void writePreviousOrderNum(int previousOrderNum) throws FlooringMasteryPersistenceException {
     ...
     private void writeOrders(List<OrderData> orders, LocalDate orderDate) throws FlooringMasteryPersistenceException {
        ...
        out.println(HEADER);
        for (OrderData currentOrder : orders) {
