...
public class OrderData {
    ...
    public int hashCode() {
        ...
        hash = 59 * hash + Objects.hashCode(this.stateAbbr);
        ...
        hash = 59 * hash + Objects.hashCode(this.productCostPerSqFt);
    ...
    public String toString() {
        return "Date: " + date + " |OrderNum: " + orderNum + " |CustomerName: " + customerName + " |Product: " + productType + " |State: " + stateAbbr;
    }
