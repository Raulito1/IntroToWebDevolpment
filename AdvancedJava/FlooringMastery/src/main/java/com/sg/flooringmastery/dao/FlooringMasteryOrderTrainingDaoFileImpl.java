 ...
 * @author raulalvarado
 */
public class FlooringMasteryOrderTrainingDaoFileImpl implements FlooringMasteryOrderDao {
    ...
    // Constructor
    public FlooringMasteryOrderTrainingDaoFileImpl() {
        
    }
    
    public FlooringMasteryOrderTrainingDaoFileImpl(String ordersFolder) {
