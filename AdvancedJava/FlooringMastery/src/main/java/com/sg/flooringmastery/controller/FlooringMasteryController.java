...
public class FlooringMasteryController {
    ...
    public void run() throws OrderValidationException, StateValidationException, ProductValidationException {
    ...
    private void editOrder() throws FlooringMasteryPersistenceException {
        ...
        } catch (InvalidOrderNumberException | ProductValidationException | StateValidationException e) {
            view.displayErrorMessage(e.getMessage());
        }
    }
